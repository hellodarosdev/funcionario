...
public class FuncionarioApplicationService implements FuncionarioService{
    ...
    private Funcionario getFuncionario(UUID idFuncionario) {
        return funcionarioRepository.buscaFuncionarioAtravesId(idFuncionario);
    }
    ...
    public void patchAlteraFuncionario(UUID idFuncionario, FuncionarioAlteracaoRequest funcionarioAlteracaoRequest) {
        ...
        Funcionario funcionario = getFuncionario(idFuncionario);
        if (funcionario.possuiMesmosDados(funcionarioAlteracaoRequest)) {
            throw APIException.build(HttpStatus.CONFLICT, "Funcionário já possui esses dados!");}
